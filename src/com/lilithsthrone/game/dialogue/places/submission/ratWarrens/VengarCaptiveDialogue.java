					...
					if(index==2) {
						return new Response("Watch",
							...
							public void effects() {
								...
								Main.game.getNpc(Silence.class).ingestFluid(null, Subspecies.RAT_MORPH, Subspecies.RAT_MORPH, new Fluid(FluidType.CUM_RAT_MORPH), SexAreaOrifice.VAGINA, 400);
							}
						};
					}
					break;
			...
			if(index==1) {
				...
				return new Response("Leave",
					...
					public void effects() {
						...
						getMainCompanion().ingestFluid(null, Subspecies.RAT_MORPH, Subspecies.RAT_MORPH, new Fluid(FluidType.CUM_RAT_MORPH), SexAreaOrifice.MOUTH, 300);
					}
				};
			}
			return null;
